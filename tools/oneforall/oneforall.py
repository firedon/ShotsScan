...
from tools.oneforall.export import *
from tools.oneforall.brute import Brute
from tools.oneforall.common import utils, resolve, request
from tools.oneforall.modules.collect import Collect
from tools.oneforall.modules.srv import BruteSRV
from tools.oneforall.modules.finder import Finder
from tools.oneforall.modules.altdns import Altdns
from tools.oneforall.modules.enrich import Enrich
from tools.oneforall.modules import wildcard
from tools.oneforall.config import settings
...
class OneForAll(object):
    ...
    def export_data1(self):
        ...
        :rtype: list
        """
        return export_data(self.domain, alive=self.alive, fmt=self.fmt, path=self.path)
